...
// Vercel invokes api/index.ts directly per-request and never runs this file
// as a long-lived process, so guard against accidentally binding a port
// (and double-registering routes) during its build/bundling step.
