    ...
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl z-10 flex flex-col justify-between overflow-y-auto animate-in slide-in-from-right duration-300">
        ...
        <div className="p-4 space-y-1.5 flex-1 overflow-y-auto">
          ...
          {/* Partner & Workspace Desks */}
          <div className="pt-3 border-t border-slate-100 space-y-1.5">
            <button
              onClick={() => handleNavigate('broker-login')}
              className="w-full px-4 py-2.5 rounded-2xl text-xs font-bold text-slate-700 hover:text-blue-900 bg-blue-50/70 hover:bg-blue-100/70 flex items-center justify-between transition-colors cursor-pointer"
            >
              <div className="flex items-center space-x-2.5">
                <Briefcase className="w-4 h-4 text-[#1E4FA8]" />
                <span className="font-extrabold text-blue-950">Broker Workspace & Sign In</span>
              </div>
              <KeyRound className="w-3.5 h-3.5 text-[#1E4FA8]" />
            </button>

            <button
              onClick={() => handleNavigate('affiliate-login')}
              className="w-full px-4 py-2.5 rounded-2xl text-xs font-bold text-slate-700 hover:text-amber-900 bg-amber-50/70 hover:bg-amber-100/70 flex items-center justify-between transition-colors cursor-pointer"
            >
              <div className="flex items-center space-x-2.5">
                <BadgeCheck className="w-4 h-4 text-amber-600" />
                <span className="font-extrabold text-amber-950">Affiliate Partner & Sign In</span>
              </div>
